        ...
        success: function (result) {
            ...
            if (Number(result.code) == 200) {
                $.each(result.data.list,function (k,v) {
                    ...
                    _html += "<tr><td class='w5'>"+v.school_name+"</td><td>"+v.school_tel+"</td>"
                    _html += "<tr><td class='w5'>"+v.worker_time+"</td><td>"+v.address+"</td>"
                    _html += "<tr><td class='w5'>"+v.school_img+"</td>"
    ...
    $.ajax({
        ...
        success: function (result) {
            if (Number(result.code) == 200) {
                ...
                $("#addform #school_name").val(result.data.school_name)
                $("#addform #school_tel").val(result.data.school_tel)
                $("#addform #school_img").val(result.data.school_img)
                $("#addform #province_name").val(result.data.province_name)
                $("#addform #province").val(result.data.province)
                $("#addform #address").val(result.data.address)
                $("#myModal2").modal("show");
            } else {
                initInput()
            }
