    ...
    a.fn.extend({
        YuxiSlider: function(b) {
            ...
            return a(this).each(function() {
                ...
                g = 0,
                h = null,
                i = '<div class="desc"><p class="title"><a href="javascript:;"></a></p><span class="num"><em class="curr-num"></em><em class="line"></em><em class="total-num"></em></span></div><div class="bg"></div>';
                b.append(i);
                var j = a("p.title a", b),
                k = a("em.curr-num", b),
                l = a("em.total-num", b),
