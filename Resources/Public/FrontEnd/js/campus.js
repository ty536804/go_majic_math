...
var uploadedDataURL = "/static/FrontEnd/js/data-1528971808162-BkOXf61WX.json";
myChart.showLoading();
var symbolSize =0;
var data = [
    {
        ...
        success: function (result) {
            ...
            if (Number(result.code) == 200) {
                $.each(result.data,function (k,v) {
                    _html +='<dl><dt><img src="/static/upload/'+v.school_img+'"></dt>'
                    _html +='<dd><h3>'+v.school_name+'</h3>'
                    _html +='<p class="phone">'+v.school_tel+'</p>'
